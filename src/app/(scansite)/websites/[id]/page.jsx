  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <Link
          href={`/websites/${site.id}/events`}
          className="mt-3 inline-flex items-center rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-50"
        >
          View Raw Events →
        </Link>
      </header>
